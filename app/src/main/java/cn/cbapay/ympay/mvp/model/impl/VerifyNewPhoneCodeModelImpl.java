...
public class VerifyNewPhoneCodeModelImpl implements VerifyNewPhoneCodeModel {
    private static final String TAG = "VerifyNewPhoneCodeModelImpl";

    private VerifyCodeListener mVerifyCodeListener;
    private final CompositeSubscription mCompositeSubscription = new CompositeSubscription();

    public VerifyNewPhoneCodeModelImpl(VerifyCodeListener l) {
        this.mVerifyCodeListener = l;
    }

    @Override
    public void verifyCode(NewPhoneVerifyRequestBean bean) {
        Subscription o = HttpUtils.updateMAlready(bean)
