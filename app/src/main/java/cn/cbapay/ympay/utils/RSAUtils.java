...
public class RSAUtils {
     ...
     * RSA最大加密明文大小
     * 除以8计算字节
     * 11表示PKCS#1建议的padding占用了11个字节
     */
    private static final int MAX_ENCRYPT_BLOCK = RSA_KEY_LENGTH / 8 - 11;

    /**
     * RSA最大解密密文大小
     */
    private static final int MAX_DECRYPT_BLOCK = RSA_KEY_LENGTH / 8;
