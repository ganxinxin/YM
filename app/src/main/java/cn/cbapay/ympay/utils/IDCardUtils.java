...
public class IDCardUtils {
    ...
    public static boolean IDCardValidate(String IDStr) {
        try {
            ...
            if (IDStr.length() != 15 && IDStr.length() != 18) {
                ...
                //Tools.showToast(MyApplication.getInstance().getApplicationContext(), errorInfo);
                return false;
            }
            // =======================(end)========================
            ...
            if (IDStr.length() == 18) {
                ...
                Tools.showToast(MyApplication.getInstance().getApplicationContext(), "所在地区:"
                        + h.get(Ai.substring(0, 2).toString()));
                //Tools.showToast(MyApplication.getInstance().getApplicationContext(), "新身份证号:" + Ai);
                return true;
            }
            // =====================(end)=====================
            //Tools.showToast(cn.cbapay.ympay.app.MyApplication.getInstance().getApplicationContext(), );("所在地区:" + h.get(Ai.substring(0, 2).toString()));
            return true;
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @return
     */
    public static boolean isChild(String IDStr) {
        if (!IDCardValidate(IDStr)) {
            return false;
        }
        String Ai = "";
        int age = 0;
        ...
        // ================ 出生年月是否有效 ================
        int year = Integer.parseInt(Ai.substring(6, 10));// 年份
        int month = Integer.parseInt(Ai.substring(10, 12));// 月份
        int day = Integer.parseInt(Ai.substring(12, 14));// 日子
