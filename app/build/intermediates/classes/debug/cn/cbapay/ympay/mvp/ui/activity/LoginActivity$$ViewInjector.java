...
public class LoginActivity$$ViewInjector {
  public static void inject(Finder finder, final cn.cbapay.ympay.mvp.ui.activity.LoginActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131427486, "field 'etUsername'");
    ...
    view = finder.findRequiredView(source, 2131427487, "field 'btLogin' and method 'onClick'");
    ...
    view = finder.findRequiredView(source, 2131427488, "method 'onClick'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131427489, "method 'onClick'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
