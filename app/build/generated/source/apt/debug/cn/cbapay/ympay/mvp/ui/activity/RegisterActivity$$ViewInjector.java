...
public class RegisterActivity$$ViewInjector {
  public static void inject(Finder finder, final cn.cbapay.ympay.mvp.ui.activity.RegisterActivity target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131165275, "field 'etPhone'");
    ...
    view = finder.findRequiredView(source, 2131165239, "field 'cbAgree'");
    ...
    view = finder.findRequiredView(source, 2131165431, "method 'onClick'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
